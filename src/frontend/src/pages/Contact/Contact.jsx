    ...
    <div className="contact-container">
      ...
      <div className="contact-options">
        <div ref={emailRef} className={`contact-option ${emailInView ? 'reveal' : ''}`}>
          <FontAwesomeIcon icon={faEnvelope} size="6x" className="icon-color" />
          <h3>E-mail</h3>
        ...
        <div ref={instagramRef} className={`contact-option ${instagramInView ? 'reveal' : ''}`}>
          <FontAwesomeIcon icon={faInstagram} size="6x" className="icon-color" />
          <h3>Instagram</h3>
        ...
        <div ref={xRef} className={`contact-option ${xInView ? 'reveal' : ''}`}>
          <FontAwesomeIcon icon={faXTwitter} size="6x" className="icon-color" />
          <h3>X</h3>
